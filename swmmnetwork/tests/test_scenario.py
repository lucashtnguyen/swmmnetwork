...
from swmmnetwork import ScenarioHydro, ScenarioLoading
...
class TestScenarioHydro(object):
    def setup(self):
        ...
        self.known_all_nodes = pd.read_csv(data_path('all_nodes.csv'), index_col=[0])
        self.known_all_edges = pd.read_csv(data_path('all_edges.csv'), index_col=[0])
...
class TestScenarioLoading(object):
    def setup(self):
        self.known_all_nodes = pd.read_csv(data_path('all_nodes.csv'), index_col=[0])
        self.known_all_edges = pd.read_csv(data_path('all_edges.csv'), index_col=[0])
        self.known_edges_vol = pd.read_csv(data_path('edges_vol.csv'), index_col=[0])
